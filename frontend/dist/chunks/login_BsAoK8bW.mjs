...
import { getContrastRatio, lighten, darken } from '@mui/system/colorManipulator.js';
import 'react';
import PropTypes from 'prop-types';
import { ThemeProvider as ThemeProvider$2 } from '@mui/system';
...
function ThemeProvider$1(_ref) {
  ...
  return /*#__PURE__*/jsx(ThemeProvider$2, _extends({}, props, {
...
const $$Login = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "BetInsights - Login" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main> ${renderComponent($$result2, "ThemeProvider", ThemeProvider, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/home/rama-canon/faidarise-project/frontend/src/components/ThemeProvider", "client:component-export": "ThemeProvider" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "LoginForm", LoginForm, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/home/rama-canon/faidarise-project/frontend/src/components/LoginForm", "client:component-export": "default" })} ` })} </main> ` })}`;
}, "/home/rama-canon/faidarise-project/frontend/src/pages/login.astro", void 0);

const $$file = "/home/rama-canon/faidarise-project/frontend/src/pages/login.astro";
const $$url = "/login";
